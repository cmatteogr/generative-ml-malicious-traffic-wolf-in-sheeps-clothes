...
mlflow.set_experiment("generative_ml_malicious_generator_b_tcvae")

# Define the name for the registered model in MLflow Model Registry
model_deployed_name = 'generative_ml_malicious_generator_b_tcvae'
...
with mlflow.start_run() as run:
    ...
    model_filepath = train(results_folder_path=results_folder_path, traffic_data_filepath=train_traffic_filepath, batch_size=2048)
