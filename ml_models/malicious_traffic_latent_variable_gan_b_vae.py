...
def log_normal_diag(x, mu, log_var, reduction=None, dim=None):
    ...
    # The function essentially answers the question: "Given a Gaussian distribution defined by mu and log_var, how likely is it that we would observe the value x?"
